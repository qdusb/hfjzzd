  ...
  <tr> 
    <td style="border:1px solid #666666;padding:3px;"><table width="100%" border="0" cellpadding="3" cellspacing="0">
        ...
        <tr> 
          <td><blockquote> 
              <br><p>
                MineVote投票系统 是一个开放源程序的PHP投票系统，程序采用文本方式存储数据，无需数据库的支持。
                ...
                <p>注：该系统使用了ASP版公用投票系统的Flash及后台的界面方案<a href="http://vote.lygpc.com/" target="_blank"><span class=en>(vote.lygpc.com)</span></a>。在些对原作者表示感谢！
              </p>
            </blockquote></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td bgcolor="#FFFFFF"> 
            <blockquote><font color="#FF6600"><strong><br>
              ...
              这里调用非常简单，只需要调用根目录下的<font color="#FF6600">showvote.js</font>就可以了，具体的调用方法是，在你需要插入投票系统的地方，插入这样一条语句 
              <font color="#FF6600"><br>
              &lt;script src=&quot;showvote.js&quot;&gt;&lt;/script&gt;<br>
              </font>这样投票系统打开的就是最新的一个并且打开的投票项目。那么如果我需要指定打开某一个项目那怎么办呢？这个也非常简单，还是插入这样的语句，不同的是需要打开<font color="#FF6600">showvote.js</font>这个页面，在<br>
              <font color="#FF6600">document.write(&quot; &lt;param name='movie' 
              value='flashvote.swf'&gt;&quot;);<br>
              </font>这个语句中的<font color="#FF6600">flashvote.swf</font>后加上<font color="#FF6600">?thisvoteid=你所要显示的投票项目的ID号</font>，如<br>
              <font color="#FF6600">document.write(&quot; &lt;param name='movie' 
              value='flashvote.swf?thisvoteid=28'&gt;&quot;);<br>
              </font>这样就首先打开ID为28的投票项目。（项目的ID号可以在后台管理中看到）<br>
              如果你需要调用的flash在网页中背景透明，那么就把<font color="#FF6600">showvote.js</font>页面中的第四行，这个语句<br>
